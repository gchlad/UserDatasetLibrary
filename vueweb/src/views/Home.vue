        ...
        .todo-form {
            ...
            .header {
                ...
                .router-link-exact-active {
                    color: #b05b3b;
                    background-color: rgba(255, 255, 255, 0.6);
                    box-shadow: inset -3px -3px 7px 0px rgba(255, 255, 255, 0.3), inset 3px 3px 5px 0px rgba(0, 0, 0, 0.5);
                    border-radius: 8px;
                    transition: 0.3s;
                }
            }
            ...
            .content {
                ...
                :nth-child(odd):not(i):not(p) {
                    ...
                    box-shadow: 5px 5px 25px rgba(0, 0, 0, 0.3), 5px 5px 5px rgba(0, 0, 0, 0.3);
                }
